...
export const login_msg = defineMessages({
  ...
  btn_contact: {
    id: 'btn_contact',
    defaultMessage: 'If you cannot receive the authentication code, please contact the administrator'
  },
  tip_info: {
    id: 'tip_info',
  ...
  title_pre: {
    id: 'title_pre',
    defaultMessage: 'Shenzhen International Exhibition Center'
  },
  title_sufix: {
    id: 'title_sufix',
  ...
  code_send: {
    id: 'code_send',
    defaultMessage: 'Verification code successfully sent to：',
  },
})